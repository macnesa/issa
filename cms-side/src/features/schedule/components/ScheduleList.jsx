export default function ScheduleList({ days, schedulesByDay }) {
  ...
  return <section className="weekly-timetable" aria-label="Jadwal mingguan kelas"><div className="weekly-timetable__intro"><p>Weekly timetable · lima hari sekolah</p></div><div className="weekly-timetable__days">{days.map((day) => {
