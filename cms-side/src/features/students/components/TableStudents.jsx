...
export default function TableStudent({ data }) {
  ...
  return <tr className="teacher-roster-row border-t border-[var(--border)] text-[var(--text)]">
    ...
    <td className="px-5 py-4 text-right"><Link to={`/students/${data.id}`}><SecondaryButton className="teacher-roster-row__action" type="button">Buka detail</SecondaryButton></Link></td>
  </tr>;
}
