    ...
    <>
      {loading ? (
        ...
        <div className={tw("relative overflow-x-auto shadow-md sm:rounded-lg ml-6 mr-6 mt-[4rem] w-full md:w-full sm:[50%]")}>
          ...
          <div className={tw("flex items-center justify-end pb-4 bg-white dark:bg-gray-900 mr-[20rem]")}>
            <div className={tw("ml-[4rem]")}>
              <Link to="/newAdmin">
                <button
                  className={tw("inline-flex items-center text-gray-300  border border-gray-900 focus:outline-none bg-gray-900 hover:text-white focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-1.5 dark:bg-gray-800 dark:text-gray-400 h-10")}
                  type="button"
                >
                  Add Teacher
                </button>
