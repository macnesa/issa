  ...
  return (
    <>
      {loading ? (
        ...
        <div className={tw("relative overflow-x-auto shadow-md sm:rounded-lg ml-6 mr-6 mt-[2rem] w-full md:w-full sm:[50%]")}>
          <div className={tw("flex items-center justify-center pb-4 bg-white dark:bg-gray-900 ml-6 mr-6")}>
            <div className={tw("grow-0 shrink-1 md:shrink-0 basis-auto xl:w-4/12 lg:w-4/12 md:w-7/12 mb-12 md:mb-[5rem] ")}>
              ...
              <p className={tw("dark:text-white font-sans font-semibold text-[1.3rem] text-center mt-6")}>HISTORY</p>
            </div>
          </div>
          <div className={tw("flex items-center justify-end pb-4 bg-white dark:bg-gray-900 ml-6 mr-[18rem] mb-14")}>
            <div className={tw("flex justify-end ")}>
              <input
                ...
                className={tw("input input-bordered  max-w-xs block p-2 pl-10 text-sm text-gray-900 border border-gray-900 rounded-lg w-80 dark:bg-gray-700 focus:ring-blue-500 focus:border-blue-500  dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 h-10")}
              />
            </div>
            <div className={tw("ml-4")}>
              <button
                onClick={submitQuery}
                className={tw("inline-flex items-center  dark:bg-gray-700 border border-gray-900 focus:outline-none bg-gray-900 text-white dark:text-white focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-1.5 :bg-gray-800  h-10")}
                type="button"
              >
                Search
              </button>
          ...
          <table className={tw("w-full text-l text-left text-gray-500 dark:text-gray-400 mt-6")}>
            <thead className={tw("text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 text-center")}>
              <tr>
                <th scope="col" className={tw("px-12 py-3")}>
                  No
                </th>
                <th scope="col" className={tw("px-12 py-3")}>
                  Description
