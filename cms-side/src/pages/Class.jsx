        ...
        <div className={tw("relative overflow-x-auto shadow-md sm:rounded-lg ml-6 mr-6 mt-[2rem] w-full md:w-full sm:[50%]")}>
          <div className={tw("flex items-center justify-center pb-4 bg-white dark:bg-gray-900 ml-6 mr-6")}>
            <div className={tw("grow-0 shrink-1 md:shrink-0 basis-auto xl:w-4/12 lg:w-4/12 md:w-7/12 mb-12 md:mb-[5rem] ")}>
              ...
              <p className={tw("dark:text-white font-sans font-semibold text-[1.3rem] text-center mt-6")}>CLASSES</p>
            </div>
          </div>
          <div className={tw("w-[80%] text-l text-left text-gray-500 dark:text-gray-400 mt-6 flex justify-end")}>
            <Link to="/formClass">
              <button
                className={tw("inline-flex items-center  dark:text-white border border-gray-900 focus:outline-none bg-gray-900 text-white focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-1.5 dark:bg-gray-800 h-10")}
                type="button"
              >
                Add Class
              </button>
          ...
          <table className={tw("w-[80%] text-l text-left text-gray-500 dark:text-gray-400 mt-6 mx-auto")}>
